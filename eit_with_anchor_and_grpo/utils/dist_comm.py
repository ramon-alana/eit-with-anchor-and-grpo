...
def get_local_rank() -> int:
    ...
    # 'RANK': '3', 'WORLD_SIZE': '4', 'LOCAL_RANK': '3', 'LOCAL_WORLD_SIZE': '4'
...
_TORCH_DISTRIBUTED_ENV_VARS = ("MASTER_ADDR", "MASTER_PORT", "RANK", "WORLD_SIZE", "LOCAL_RANK", "LOCAL_WORLD_SIZE")
...
class _TorchDistributedEnvironment:
    ...
    def export(self, *, overwrite: bool) -> "_TorchDistributedEnvironment":
        ...
        env_vars = {"MASTER_ADDR": self.master_addr, "MASTER_PORT": str(self.master_port), "RANK": str(self.rank), "WORLD_SIZE": str(self.world_size), "LOCAL_RANK": str(self.local_rank), "LOCAL_WORLD_SIZE": str(self.local_world_size)}
        print(env_vars)
...
def enable_distributed(*, use_torchrun=False, set_cuda_current_device: bool = True, overwrite: bool = False):
